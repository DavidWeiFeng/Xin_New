...
"")
        ...
        self.settingListWidget.setGeometry(QRect(0, 310, 71, 161))
...
"")
        ...
        self.stackedWidget.setGeometry(QRect(80, 0, 551, 301))
        self.page = QWidget()
        ...
        self.skillSetting.setGeometry(QRect(0, 210, 351, 81))
        ...
        self.startXuexili.setGeometry(QRect(400, 220, 81, 51))
        self.label_3 = QLabel(self.page)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(400, 270, 111, 31))
        self.layoutWidget4 = QWidget(self.page)
        self.layoutWidget4.setObjectName(u"layoutWidget4")
        self.layoutWidget4.setGeometry(QRect(2, 181, 482, 23))
        ...
        self.catchSettingGroupBox.setGeometry(QRect(10, 80, 531, 141))
        ...
        self.layoutWidget5.setGeometry(QRect(80, 70, 400, 21))
        self.horizontalLayout_7 = QHBoxLayout(self.layoutWidget5)
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.cactusCheckBox = QCheckBox(self.layoutWidget5)
        self.cactusCheckBox.setObjectName(u"cactusCheckBox")

        self.horizontalLayout_7.addWidget(self.cactusCheckBox)

        self.shinyAndRareCheckBox = QCheckBox(self.layoutWidget5)
        self.shinyAndRareCheckBox.setObjectName(u"shinyAndRareCheckBox")

        self.horizontalLayout_7.addWidget(self.shinyAndRareCheckBox)

        self.onlyHighCheckBox2 = QCheckBox(self.layoutWidget5)
        self.onlyHighCheckBox2.setObjectName(u"onlyHighCheckBox2")

        self.horizontalLayout_7.addWidget(self.onlyHighCheckBox2)

        self.onlyHighCheckBox = QCheckBox(self.layoutWidget5)
        self.onlyHighCheckBox.setObjectName(u"onlyHighCheckBox")

        self.horizontalLayout_7.addWidget(self.onlyHighCheckBox)

        self.widget = QWidget(self.catchSettingGroupBox)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(82, 111, 218, 21))
        ...
        self.lockButton = QRadioButton(self.widget)
        ...
        self.startCatch.setGeometry(QRect(400, 230, 81, 51))
        self.label_4 = QLabel(self.page_2)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(400, 280, 111, 31))
        ...
        self.logText.setGeometry(QRect(80, 310, 591, 171))
...
"")
        ...
        self.killShinyCheckBox = QCheckBox(Form)
        self.killShinyCheckBox.setObjectName(u"killShinyCheckBox")
        self.killShinyCheckBox.setGeometry(QRect(10, 240, 71, 21))
    ...
    def retranslateUi(self, Form):
        ...
        self.dayiwaButton.setText(QCoreApplication.translate("Form", u"\u4f0a\u5a05\u4e1d", None))
        ...
        self.chaerdunButton.setText(QCoreApplication.translate("Form", u"\u67e5\u5c14\u987f", None))
        self.tiliGroupBox.setTitle(QCoreApplication.translate("Form", u"\u4f53\u529b", None))
        self.dadinggeButton.setText(QCoreApplication.translate("Form", u"\u4e01\u9c81\u7279", None))
        ...
        self.catchSettingGroupBox.setToolTip(QCoreApplication.translate("Form", u"\u51c6\u5907\u597d\u5de8\u578b\u4ed9\u4eba\u638c + \u521d\u7ea7\u6d3b\u529b\u836f\u5242", None))
...
#if QT_CONFIG(tooltip)
        self.cactusCheckBox.setToolTip(QCoreApplication.translate("Form", u"\u51c6\u5907\u597d\u5de8\u578b\u4ed9\u4eba\u638c + \u521d\u7ea7\u6d3b\u529b\u836f\u5242", None))
#endif // QT_CONFIG(tooltip)
        self.cactusCheckBox.setText(QCoreApplication.translate("Form", u"\u4ed9\u4eba\u638c\u50ac\u7720", None))
#if QT_CONFIG(tooltip)
        self.shinyAndRareCheckBox.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.shinyAndRareCheckBox.setText(QCoreApplication.translate("Form", u"\u540c\u65f6\u6355\u6349\u7a00\u6709", None))
        self.onlyHighCheckBox2.setText(QCoreApplication.translate("Form", u"\u7a00\u6709\u53ea\u6293\u9ad8\u4e2a\u4f53", None))
        self.onlyHighCheckBox.setText(QCoreApplication.translate("Form", u"\u6293\u666e\u901a\u9ad8\u4e2a\u4f53", None))
#if QT_CONFIG(tooltip)
        self.defaultButton_2.setToolTip(QCoreApplication.translate("Form", u"\u8fdb\u5165\u5bf9\u6218\uff0c\u4e0d\u662f\u5f02\u8272\u5c31\u9003\u8dd1", None))
#endif // QT_CONFIG(tooltip)
        self.defaultButton_2.setText(QCoreApplication.translate("Form", u"\u660e\u6697\u96f7\u6a21\u5f0f", None))
#if QT_CONFIG(tooltip)
        self.lockButton.setToolTip(QCoreApplication.translate("Form", u"\u9700\u8981\u642d\u914d\u9501\u56fe\u5de5\u5177", None))
#endif // QT_CONFIG(tooltip)
        self.lockButton.setText(QCoreApplication.translate("Form", u"\u9501\u56fe\u6a21\u5f0f(\u53cc\u500d\u6548\u7387)", None))
        ...
        self.killShinyCheckBox.setText(QCoreApplication.translate("Form", u"\u6253\u6b7b\u5f02\u8272", None))
    # retranslateUi
