package com.robot.petFightModule.ui.controlPanel
{
   ...
   public class FightCatchItemPanel extends BaseControlPanel implements IControlPanel
   {
      ...
      public function FightCatchItemPanel()
      {
         super();
      ...
      private function showCatchPetItem(param1:Array) : void
      {
