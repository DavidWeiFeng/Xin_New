package com.robot.core.config.xml
{
   ...
   public class SkillXMLInfo
   {
      ...
      public static var sideEffectMap:HashMap = new HashMap();
      ...
      public static function parseInfo(callBack:Function) : void
      {
         var onLoad:Function = function(_arg_1:XML):void
         {
            var _loc7_:XML = null;
            var _loc8_:XML = null;
            for each(_loc8_ in _arg_1.descendants("Move"))
            {
               moveStoneMap.add(uint(_loc8_.@ID),_loc8_);
            }
            _loc7_ = null;
            for each(_loc7_ in _arg_1.descendants("SideEffect"))
            {
               sideEffectMap.add(uint(_loc7_.@ID),_loc7_);
            }
            callBack();
            xmlLoader = null;
         };
      ...
      public static function getName(id:uint) : String
      {
         var _loc2_:XML = null;
         var _loc3_:String = "";
         _loc2_ = moveStoneMap.getValue(id);
         return _loc2_.@Name;
      }
      ...
      public static function getSideEffects(id:uint) : Array
      {
         ...
         var _loc2_:XML = null;
         _loc2_ = moveStoneMap.getValue(id);
         _loc3_ = _loc2_.@SideEffect;
         return String(_loc3_).split(" ");
      }
      ...
      public static function getCategory(id:uint) : int
      {
         ...
         var _loc3_:uint = 0;
         _loc2_ = moveStoneMap.getValue(id);
         return uint(_loc2_.@Category);
      }
      
      public static function getCategoryName(_arg_1:uint) : String
      {
         return categoryNames["key_" + getCategory(_arg_1)];
      }
      ...
      public static function getTypeCN(id:uint) : String
      {
         ...
         var xml:XML = moveStoneMap.getValue(id);
         type = xml.@Type;
         return dict["key_" + type]["cn"];
      }
      
      public static function getTypeCNBytTypeID(_arg_1:uint) : String
      {
         return dict["key_" + _arg_1]["cn"];
      }
      ...
      public static function getTypeEN(id:uint) : String
      {
         ...
         var _loc4_:XML = null;
         var _loc5_:uint = 0;
         _loc4_ = moveStoneMap.getValue(id);
         _loc5_ = uint(_loc4_.@Type);
         return dict["key_" + _loc5_]["en"];
      }
      ...
      public static function getTypeID(param1:uint) : uint
      {
         var _loc2_:XML = null;
         var _loc3_:uint = 0;
         _loc2_ = moveStoneMap.getValue(param1);
      ...
      {
         var _add:String = null;
         var _loc2_:XML = null;
         _loc2_ = sideEffectMap.getValue(id);
         return _loc2_.@des;
      }
      
      public static function petTypeName(_arg_1:uint) : String
      {
         var _local_2:String = dict["key_" + _arg_1]["cn"];
         return dict["key_" + _arg_1]["cn"];
      }
      ...
      public static function getCritRate(id:uint) : int
      {
         ...
         var _loc2_:XML = null;
         _loc2_ = moveStoneMap.getValue(id);
         _add = Number(_loc2_.@CritRate);
         return Boolean(_add) ? int(_add) : 1;
      }
