package com.robot.core.config.xml
{
   ...
   public class AchieveXMLInfo
   {
      ...
      private static var _path:String = "500";
      ...
      {
         var _loc1_:XML = null;
         var _loc2_:XMLList = xml.type.Branches.Branch.Rule;
         var _loc3_:int = 0;
         for each(_loc1_ in _loc2_)
         {
            _loc3_ += int(_loc1_.@AchievementPoint);
         }
         Alarm.show("总的成就点数为：" + _loc3_);
      }
