package com.robot.core.aticon
{
   ...
   public class FlyAction implements IWalk
   {
      ...
      public function FlyAction(_arg_1:IActionSprite)
      {
         super();
         this.init();
         this._obj = _arg_1;
      ...
      public function execute_point(_arg_1:IActionSprite, _arg_2:Point, _arg_3:Boolean = true) : void
      {
      }
      ...
      private function fly(_arg_1:Number, _arg_2:Point, _arg_3:Point) : void
      {
         if(!this._obj)
         {
            return;
         ...
         this._tween = TweenMax.to(this._obj,_arg_1,{
            "bezier":[{
               "x":_arg_2.x,
               "y":_arg_2.y
            },{
      ...
      private function onComHandler(_arg_1:TweenEvent) : void
      {
