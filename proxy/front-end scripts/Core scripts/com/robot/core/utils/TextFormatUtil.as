package com.robot.core.utils
{
   ...
   public class TextFormatUtil
   {
      ...
      private static var _tfm:TextFormat = new TextFormat("simsun",12,16777215,null,null,null,null,null,null,null,null,null,3);
      ...
      public static function trim(param1:String) : String
      {
         ...
         {
            if(_loc4_.indexOf(param1.charAt(_loc2_)) == -1)
            {
               break;
            }
            _loc2_++;
