package com.robot.core.utils
{
   ...
   public class HitTestDuplicate
   {
      
      public function HitTestDuplicate()
      {
         super();
      }
      ...
      public static function complexIntersectionRectangle(param1:DisplayObject, param2:DisplayObject, param3:Number = 1) : Rectangle
      {
         ...
         _loc5_.draw(param1,HitTestDuplicate.getDrawMatrix(param1,_loc4_,param3),new ColorTransform(1,1,1,1,255,-255,-255,255));
         _loc5_.draw(param2,HitTestDuplicate.getDrawMatrix(param2,_loc4_,param3),new ColorTransform(1,1,1,1,255,255,255,255),BlendMode.DIFFERENCE);
