package com.robot.core.npc
{
   ...
   public class NpcController
   {
      ...
      private static function onMapOpenHandler(_arg_1:MapEvent) : void
      {
         var _local_2:MapModel = _arg_1.mapModel;
         _info = NpcXMLInfo.getNpcXmlByMap(_local_2.id);
         if(_info != null)
         {
      ...
      private static function onComHandler(_arg_1:DisplayObject) : void
      {
         ...
         try
         {
            _local_2 = getDefinitionByName("com.robot.app.npc.npcClass.NpcClass_" + _curNpcInfo.npcId);
            if(Boolean(_local_2))
            {
               _curNpc = new _local_2(_curNpcInfo,_arg_1) as INpc;
