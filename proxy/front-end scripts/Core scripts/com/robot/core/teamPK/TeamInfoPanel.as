package com.robot.core.teamPK
{
   ...
   public class TeamInfoPanel
   {
      ...
      public function setHomeScore(_arg_1:uint) : void
      {
         this._homeScore_txt.text = String(_arg_1);
      }
      
      public function setAwayScore(_arg_1:uint) : void
      {
         this._awayScore_txt.text = String(_arg_1);
      }
      
      public function setTime(_arg_1:uint) : void
      {
         this._time_txt.text = String(_arg_1) + "分钟";
      }
