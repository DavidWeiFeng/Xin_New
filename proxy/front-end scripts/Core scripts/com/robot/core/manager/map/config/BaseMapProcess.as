package com.robot.core.manager.map.config
{
   ...
   public class BaseMapProcess
   {
      ...
      public var rootLevel:DisplayObjectContainer;
      
      public var bgLevel:DisplayObjectContainer;
      ...
      {
         super();
         this.rootLevel = MapManager.currentMap.root;
         this.bgLevel = MapManager.currentMap.backLevel;
