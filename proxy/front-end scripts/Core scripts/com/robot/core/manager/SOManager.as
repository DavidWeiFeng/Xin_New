package com.robot.core.manager
{
   ...
   public class SOManager
   {
      ...
      public static function getCommonSO(_arg_1:String) : SharedObject
      {
         return SharedObject.getLocal("common/" + _arg_1,"/");
      }
      
      public static function getUserSO(_arg_1:String) : SharedObject
      {
         return SharedObject.getLocal(MainManager.actorID + "/" + _arg_1,"/");
      }
      ...
      public static function flush(_arg_1:SharedObject) : Boolean
      {
         if(_arg_1 != null)
         {
            getFlushPool().addFlush(_arg_1);
            return true;
         }
         return false;
      }
