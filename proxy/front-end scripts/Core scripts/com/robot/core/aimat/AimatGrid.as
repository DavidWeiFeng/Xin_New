package com.robot.core.aimat
{
   ...
   public class AimatGrid extends Sprite
   {
      ...
      public function set itemID(_arg_1:uint) : void
      {
         ...
         if(this._itemID == 0)
         {
            _local_2 = UIManager.getMovieClip("ui_aimat_icon");
            ...
            this.loadPanel.setIcon(_local_2);
         }
         else
         {
      ...
      private function onLoadIcon(_arg_1:MovieClip) : void
      {
