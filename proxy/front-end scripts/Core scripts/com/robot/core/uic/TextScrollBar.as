package com.robot.core.uic
{
   ...
   public class TextScrollBar
   {
      ...
      public function TextScrollBar(_arg_1:DisplayObjectContainer, _arg_2:TextField, _arg_3:SimpleButton = null, _arg_4:SimpleButton = null)
      {
         super();
         this._barBlock = _arg_1["barBall"];
         this._barBack = _arg_1["barBg"];
         this._tf = _arg_2;
         this._upBtn = _arg_3;
         this._downBtn = _arg_4;
      ...
      private function onBarBallDown(_arg_1:MouseEvent) : void
      {
      ...
      private function onBarBallUp(_arg_1:MouseEvent) : void
      {
      ...
      private function onTxtScroll(_arg_1:Event) : void
      {
         ...
         {
            _local_2 = this._tf.scrollV / this._tf.maxScrollV;
         }
         this._barBlock.y = this._scrollRect.y + this._scrollRect.height * _local_2;
      }
