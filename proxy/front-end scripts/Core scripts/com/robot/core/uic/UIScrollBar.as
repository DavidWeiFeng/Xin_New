package com.robot.core.uic
{
   ...
   public class UIScrollBar extends EventDispatcher
   {
      ...
      public function UIScrollBar(_arg_1:Sprite, _arg_2:Sprite, _arg_3:int, _arg_4:SimpleButton = null, _arg_5:SimpleButton = null)
      {
         super();
         this._barBlock = _arg_1;
         this._barBack = _arg_2;
         this._maxCount = _arg_3;
         this._upBtn = _arg_4;
         this._downBtn = _arg_5;
      ...
      public function set lineNum(_arg_1:int) : void
      {
         this._lineNum = _arg_1;
      }
      
      public function set index(_arg_1:int) : void
      {
         if(_arg_1 < 0 || _arg_1 > this._totalLength)
         {
            return;
         }
         this._index = _arg_1;
      ...
      public function set totalLength(_arg_1:int) : void
      {
         ...
         this._barBlock.y = this._scrollRect.y;
         this._index = 0;
         if(_arg_1 > this._maxCount)
         {
            this._barBlock.mouseEnabled = true;
            this._barBlock.visible = true;
            this._per = this._scrollRect.height / (_arg_1 - this._maxCount);
      ...
      public function set wheelObject(_arg_1:InteractiveObject) : void
      {
         this._wheelObject = _arg_1;
      ...
      private function onBarBlockDown(_arg_1:MouseEvent) : void
      {
      ...
      private function onBarBlockMove(_arg_1:MouseEvent) : void
      {
         ...
         var _local_2:int = int(Math.round((this._barBlock.y - this._scrollRect.y) / this._per));
         if(_local_2 < 0)
         {
            _local_2 = 0;
         }
         if(Math.ceil(_local_2 / this._lineNum) != this._index)
         {
            this._index = Math.ceil(_local_2 / this.lineNum);
            dispatchEvent(new MouseEvent(MouseEvent.MOUSE_MOVE));
         }
      }
      
      private function onBarBlockUp(_arg_1:MouseEvent) : void
      {
      ...
      private function onBackDown(_arg_1:MouseEvent) : void
      {
      ...
      private function onWheel(_arg_1:MouseEvent) : void
      {
         ...
         {
            this._barBlock.y -= _arg_1.delta;
            this.onBarBlockMove(null);
         }
      }
      
      private function onUpDown(_arg_1:MouseEvent) : void
      {
      ...
      private function onUpUp(_arg_1:MouseEvent) : void
      {
         if(Boolean(this._upBtn.stage))
         {
            this._upBtn.stage.removeEventListener(MouseEvent.MOUSE_UP,this.onUpUp);
      ...
      private function onUpEnter(_arg_1:Event) : void
      {
         if(this._barBlock.y >= this._scrollRect.y)
         {
      ...
      private function onDownDown(_arg_1:MouseEvent) : void
      {
      ...
      private function onDownUp(_arg_1:MouseEvent) : void
      {
         if(Boolean(this._downBtn.stage))
         {
            this._downBtn.stage.removeEventListener(MouseEvent.MOUSE_UP,this.onDownUp);
      ...
      private function onDownEnter(_arg_1:Event) : void
      {
         if(this._barBlock.y <= this._scrollRect.bottom)
         {
            this._barBlock.y += this._scrollY;
      ...
      public function set scrollY(_arg_1:Number) : void
      {
         this._scrollY = _arg_1;
      }
