package com.robot.core.uic
{
   ...
   public class UIPageBar extends EventDispatcher
   {
      ...
      public function UIPageBar(_arg_1:SimpleButton, _arg_2:SimpleButton, _arg_3:TextField, _arg_4:uint)
      {
         super();
         this._preBtn = _arg_1;
         this._nextBtn = _arg_2;
         this._txt = _arg_3;
         this._pageLength = _arg_4;
      ...
      public function set pageLength(_arg_1:uint) : void
      {
         this._pageLength = _arg_1;
         this.init();
      }
      ...
      public function set totalLength(_arg_1:uint) : void
      {
