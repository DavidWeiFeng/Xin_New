package com.robot.core.info.pet
{
   ...
   public class PetTakeOutInfo
   {
      ...
      public function PetTakeOutInfo(_arg_1:IDataInput)
      {
         super();
         this._homeEnergy = _arg_1.readUnsignedInt();
         this._firstPetTime = _arg_1.readUnsignedInt();
         this._flag = _arg_1.readUnsignedInt();
         if(this.flag != 0)
         {
            this._petInfo = new PetInfo(_arg_1);
         }
      }
