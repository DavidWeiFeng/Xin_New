package com.robot.core.info.teamPK
{
   ...
   public class TeamPKResultInfo
   {
      ...
      public function TeamPKResultInfo(_arg_1:IDataInput)
      {
         super();
         ...
         this._mvp_uid = _arg_1.readUnsignedInt();
         this._thisPoint = _arg_1.readUnsignedInt();
         this._get_flag = _arg_1.readInt();
         this._destroy_hqrts = _arg_1.readInt();
         this._team_kill_player = _arg_1.readInt();
         this._team_kill_building = _arg_1.readInt();
         this._gain_coins = _arg_1.readInt();
         this._gain_badge = _arg_1.readInt();
         this._gain_exp = _arg_1.readInt();
         this._freez_times = _arg_1.readInt();
         this._kill_player = _arg_1.readInt();
         this._kill_building = _arg_1.readInt();
      }
