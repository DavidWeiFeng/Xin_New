package com.robot.core.info.teamPK
{
   ...
   public class TeamPKBeShotInfo
   {
      ...
      public function TeamPKBeShotInfo(_arg_1:IDataInput)
      {
         super();
         this._type = _arg_1.readUnsignedInt();
         this._dmg = _arg_1.readUnsignedInt();
         this._crit = _arg_1.readUnsignedInt();
         this._shooter = new ShooterInfo(_arg_1);
         this._beShooter = new ShooterInfo(_arg_1);
      }
