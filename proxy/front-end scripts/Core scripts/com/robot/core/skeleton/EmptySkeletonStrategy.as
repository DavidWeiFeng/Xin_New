package com.robot.core.skeleton
{
   ...
   public class EmptySkeletonStrategy implements ISkeleton
   {
      ...
      {
         this.clothPrev.changeDirection(_arg_1);
      }
      
      public function changeCloth(_arg_1:Array) : void
      {
         this.clothPrev.changeCloth(_arg_1);
      }
      ...
      {
         this.clothPrev.changeColor(_arg_1,_arg_2);
      }
      
      public function changeDoodle(_arg_1:String) : void
      {
         this.clothPrev.changeDoodle(_arg_1);
      }
      
      public function specialAction(_arg_1:BasePeoleModel, _arg_2:int) : void
      {
         this.clothPrev.specialAction(_arg_1,_arg_2);
      }
