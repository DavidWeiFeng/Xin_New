package com.robot.core.mode.additiveInfo
{
   ...
   public class TeamPkPlayerSideInfo implements ISpriteAdditiveInfo
   {
      ...
      public function TeamPkPlayerSideInfo(_arg_1:BasePeoleModel)
      {
         super();
         this.model = _arg_1;
      }
      ...
      public function set info(_arg_1:Object) : void
      {
         ...
         {
            this.q_mc = CoreAssetsManager.getMovieClip("red_q");
         }
         else
         {
            this.q_mc = CoreAssetsManager.getMovieClip("blue_q");
         }
