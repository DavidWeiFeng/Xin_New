package com.robot.core.mode
{
   ...
   public class BossModel extends BobyModel
   {
      ...
      public function BossModel(_arg_1:uint, _arg_2:uint)
      {
         super();
         this._id = _arg_1;
         this._region = _arg_2;
         _speed = 2;
         mouseEnabled = false;
         if(_arg_1 == 47 && MapManager.currentMap.id == 12)
         {
      ...
      public function setDirection(_arg_1:String) : void
      {
         if(_arg_1 == null || _arg_1 == "")
         {
            return;
      ...
      public function show(_arg_1:Point, _arg_2:uint) : void
      {
         this._startPos = _arg_1.clone();
         if(Boolean(this._obj))
         {
            this._isMove = true;
