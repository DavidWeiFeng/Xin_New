package com.robot.core.mode
{
   ...
   public class PKArmModel extends SpriteModel
   {
      ...
      private var redcls:Array = [CoreAssetsManager.getClass("red_build_2"),CoreAssetsManager.getClass("red_build_3"),CoreAssetsManager.getClass("red_build_4")];
      
      private var bluecls:Array = [CoreAssetsManager.getClass("blue_build_2"),CoreAssetsManager.getClass("blue_build_3"),CoreAssetsManager.getClass("blue_build_4")];
      ...
      public function PKArmModel(_arg_1:TeamPkBuildingInfo, _arg_2:Boolean = false, _arg_3:uint = 1)
      {
         super();
         this.container = new Sprite();
         addChild(this.container);
         this.colorType = _arg_3;
         this.info = _arg_1;
      ...
      public function set isEnemy(_arg_1:Boolean) : void
      {
         this._isEnemy = _arg_1;
         if(_arg_1)
         {
      ...
      public function set info(_arg_1:TeamPkBuildingInfo) : void
      {
         this._info = _arg_1;
         if(this._resURL != "")
         {
      ...
      private function onLoadRes(_arg_1:DisplayObject) : void
      {
         ...
         this.changeDir();
         var _local_2:SpriteBloodBar = new SpriteBloodBar(ShotBehaviorManager.getMovieClip("pk_blood_bar"));
         _local_2.setHp(this._info.hp,uint(FortressItemXMLInfo.getMaxHP(this._info.id,this._info.form)));
         additive = [_local_2];
      }
      ...
      private function changeDir() : void
      {
         ...
         if(this._info.id == 1)
         {
            ...
            {
               _local_1 = this.redcls[this._info.form - 2];
               this.bmp = DisplayUtil.copyDisplayAsBmp(new _local_1());
            }
            else
            {
               _local_1 = this.bluecls[this._info.form - 2];
               this.bmp = DisplayUtil.copyDisplayAsBmp(new _local_1());
            }
         }
         else
