package com.robot.core.energyExchange
{
   ...
   public class ExchangeItemInfo
   {
      ...
      public function ExchangeItemInfo(_arg_1:SingleItemInfo)
      {
         super();
         this._itemId = _arg_1.itemID;
         this._itemNum = _arg_1.itemNum;
         this._itemName = String(ItemXMLInfo.getName(_arg_1.itemID));
         this._itemDescription = ItemTipXMLInfo.getItemDes(_arg_1.itemID);
         this._itemRule = ItemXMLInfo.getRule(_arg_1.itemID);
         this._itemSellPrice = ItemXMLInfo.getSellPrice(_arg_1.itemID);
         this._leftTime = _arg_1.leftTime;
         this._isSuper = ItemXMLInfo.getIsSuper(_arg_1.itemID);
      }
