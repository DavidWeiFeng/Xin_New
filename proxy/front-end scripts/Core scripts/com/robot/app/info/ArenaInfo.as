package com.robot.app.info
{
   ...
   public class ArenaInfo
   {
      ...
      public function ArenaInfo(_arg_1:IDataInput)
      {
         super();
         this._flag = _arg_1.readUnsignedInt();
         this._hostID = _arg_1.readUnsignedInt();
         this._hostNick = _arg_1.readUTFBytes(16);
         this._hostWins = _arg_1.readUnsignedInt();
         this._challengerID = _arg_1.readUnsignedInt();
      }
