package com.robot.app.mapProcess
{
   ...
   public class MapProcess_339 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         while(_local_1 < 3)
         {
            conLevel["arrow_" + _local_1].buttonMode = true;
            conLevel["arrow_" + _local_1].addEventListener(MouseEvent.CLICK,this.onArrowMCClickHandler);
            _local_1++;
         }
      }
      ...
      private function onNpcClick(_arg_1:MouseEvent) : void
      {
         this.acceptTask133();
      }
      
      private function onSwitchMCClickHandler(_arg_1:MouseEvent) : void
      {
         this.isClicked = true;
         if(Boolean(this.switchMC))
         {
            this.switchMC.x = LevelManager.stage.mouseX - this.switchMC.width / 2;
            this.switchMC.y = LevelManager.stage.mouseY - this.switchMC.height / 2;
         }
      }
      ...
      private function onMoveHandler(_arg_1:MouseEvent) : void
      {
         ...
         if(this.isBallClicked)
         {
            ...
            {
               this.isMove = true;
               this.ballMC.x = LevelManager.stage.mouseX - this.ballMC.width / 2;
               this.ballMC.y = LevelManager.stage.mouseY - this.ballMC.height / 2;
            }
         }
         if(this.isPowerMcClicked)
         {
            if(Boolean(this.powerarrowMC))
            {
               ...
               this.powerarrowMC.y = LevelManager.stage.mouseY - this.powerarrowMC.height / 2;
            }
         }
      }
      ...
      public function onBallClickHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function onPowerMCClickHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function getAward(_arg_1:Boolean = false) : void
      {
         var _local_2:uint = 0;
         if(_arg_1)
         {
         ...
         var _local_3:DayGiftController = new DayGiftController(_local_2,5);
         _local_3.addEventListener(DayGiftController.COUNT_SUCCESS,this.onCountSuccess);
         _local_3.getCount();
      }
      ...
      private function onGetMonsterHandler(_arg_1:MouseEvent) : void
      {
         var _local_2:MouseEvent = _arg_1;
      ...
      {
         NpcDialog.show(NPC.SEER,["我不记得我是谁了……你能够带我去其它星球上走走吗？"],["去充满音乐的艾迪星？"],[function():void
         {
