package com.robot.app.mapProcess
{
   ...
   public class MapProcess_20 extends BaseMapProcess
   {
      ...
      private function clickKg(_arg_1:MouseEvent) : void
      {
      ...
      public function eatMan() : void
      {
         ...
         if(this.smMC.currentFrame < 48)
         {
            ...
            _local_1 = MainManager.actorModel.sprite;
            TweenLite.to(_local_1,1,{
               "x":275,
               "y":261,
               "alpha":0.8,
               "rotation":360,
      ...
      private function resetMan() : void
      {
         ...
         _local_1.x = 275;
         _local_1.y = 261;
         depthLevel.addChild(_local_1);
         TweenLite.to(_local_1,1.5,{
            "x":744,
            "y":383,
            "alpha":1,
            "rotation":360 * 4,
