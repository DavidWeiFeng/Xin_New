package com.robot.app.mapProcess
{
   ...
   public class MapProcess_108 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         _local_1.show("勇者之塔更新了，赛尔勇士们前进吧！",0,-85,conLevel["npc"]);
         this.configTown();
      ...
      private function onTownOverHandler(_arg_1:MouseEvent) : void
      {
         this._townMc["llmc"].visible = true;
         this._townMc["llmc"].gotoAndPlay(2);
      }
      
      private function onTownOutHandler(_arg_1:MouseEvent) : void
      {
         this._townMc["llmc"].visible = false;
         this._townMc["llmc"].gotoAndStop(1);
      }
      
      private function onLightMc1Handler(_arg_1:MouseEvent) : void
      {
      ...
      private function onLightMc2Handler(_arg_1:MouseEvent) : void
      {
      ...
      private function onTimer(_arg_1:TimerEvent) : void
      {
         ...
         _local_2.show("要申请创建战队的赛尔们，请到我这里来!",0,-85,conLevel["npc"]);
      }
      ...
      public function fightTownHandler() : void
      {
         ...
         FightMHTController.checkIsFight(function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
      ...
      private function dd() : void
      {
         ...
         var _local_2:Array = PetManager.getBagMap();
