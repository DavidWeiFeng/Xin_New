package com.robot.app.mapProcess
{
   ...
   public class MapProcess_103 extends BaseMapProcess
   {
      ...
      private function showBookHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function onBookBoxClickHandler(_arg_1:MouseEvent) : void
      {
         this.showBook();
      }
      ...
      private function onTalk2(_arg_1:SocketEvent) : void
      {
      ...
      private function onCount2(_arg_1:Event) : void
      {
      ...
      {
         var _local_1:DayOreCount = new DayOreCount();
         _local_1.addEventListener(DayOreCount.countOK,this.onCount);
         _local_1.sendToServer(2051);
      }
