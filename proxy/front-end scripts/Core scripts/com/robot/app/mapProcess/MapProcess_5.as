package com.robot.app.mapProcess
{
   ...
   import com.robot.app.petCollectBounds.*;
   ...
   public class MapProcess_5 extends BaseMapProcess
   {
      ...
      private function clickPetBookHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function tgHandler(_arg_1:MouseEvent) : void
      {
         ContributeAlert.show(ContributeAlert.DOCTOR_TYPE);
      }
      
      private function clickYangHuHandler(_arg_1:MouseEvent) : void
      {
      }
      ...
      private function showMonsterBook(_arg_1:MouseEvent) : void
      {
      ...
      {
         NpcDialog.show(NPC.DOCTOR,["精灵是赛尔的伙伴，我相信我能够发现更多的精灵秘密！"],["打开技能唤醒","打开技能排序"],[function():void
         {
            PetSelectPanel();
         },function():void
         {
      ...
      private function PetSelectPanel() : void
      {
      ...
      private function onCollect(_arg_1:MouseEvent) : void
      {
      ...
      public function check() : void
      {
         ...
         {
            NpcDialog.show(NPC.DOCTOR,["为了进一步的精灵研究，博士需要收集各星球的野生精灵来研究它们的习性。同时，博士也为大家准备了神秘的精灵作为奖励哦。"],["打开精灵收集奖励第1期","打开精灵收集奖励第2期"],[function():void
            {
               show();
            },function():void
            {
      ...
      private function onCheckSuccessHandler(_arg_1:SocketEvent) : void
      {
      ...
      private function onGetLAS(_arg_1:SocketEvent) : void
      {
         var _local_2:String = ItemXMLInfo.getName(100245);
         ItemInBagAlert.show(100245,1 + "个<font color=\'#ff0000\'>" + _local_2 + "</font>已经放入你的储存箱中！");
      }
      ...
      private function showTaskPanelComp_7(_arg_1:DynamicEvent) : void
      {
      ...
      public function showNpcDialog() : void
      {
         ...
         else if(TasksManager.getTaskStatus(98) == TasksManager.ALR_ACCEPT)
         {
            TasksManager.getProStatusList(TaskController_98.TASK_ID,function(arr:Array):void
            {
               ...
               {
                  TasksManager.complete(TaskController_98.TASK_ID,5,function(_arg_1:Boolean):void
                  {
                     if(_arg_1)
                     {
                        conLevel["nibu_npc"].visible = false;
