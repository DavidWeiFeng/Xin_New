package com.robot.app.mapProcess
{
   ...
   public class MapProcess_512 extends BaseMapProcess
   {
      ...
      public function MapProcess_512()
      {
         super();
      }
      ...
      public function clickLineBelt() : void
      {
         ...
         {
            NpcTipDialog.show("只有精灵跟随在身边才能给它进行训练噢!",null,NpcTipDialog.DOCTOR);
         }
      }
      ...
      private function onLoadDLL(_arg_1:MCLoadEvent) : void
      {
         ...
         var _local_3:SimpleButton = Sprite(_local_2.getChildAt(0)).getChildAt(4)["close_btn"];
         this.helpMC = Sprite(_local_2.getChildAt(0)).getChildAt(5) as MovieClip;
         _local_3.addEventListener(MouseEvent.CLICK,this.extCloseHandler);
      }
      
      private function extCloseHandler(_arg_1:MouseEvent) : void
      {
         if(!this.helpMC.stage)
         {
            return;
         }
         var _local_2:* = this.curDisplayObj as Sprite;
