package com.robot.app.mapProcess
{
   ...
   public class MapProcess_314 extends BaseMapProcess
   {
      ...
      private function onRecorderClickHandler(_arg_1:MouseEvent) : void
      {
         if(Boolean(this.clickMC))
         {
            if(_arg_1.currentTarget != this.clickMC)
            {
         ...
         {
            this.clickMC = _arg_1.currentTarget as SimpleButton;
      ...
      private function onBossMCClickHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function onDoorMCClickHandler(_arg_1:MouseEvent) : void
      {
         if(this.doorMC.hasEventListener(Event.ENTER_FRAME))
         {
            this.doorMC.removeEventListener(Event.ENTER_FRAME,this.onDoorEffectHandler);
      ...
      private function onDoorEffectHandler(_arg_1:Event) : void
      {
