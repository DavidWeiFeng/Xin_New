package com.robot.app.mapProcess
{
   ...
   public class MapProcess_324 extends BaseMapProcess
   {
      ...
      private function taskStatus(_arg_1:Array) : void
      {
         var _local_2:MovieClip = null;
         if(Boolean(_arg_1[3]) && !_arg_1[4])
         {
            for each(_local_2 in this.gainsArr)
            {
               _local_2.buttonMode = true;
               _local_2.addEventListener(MouseEvent.CLICK,this.onClickGains);
            }
      ...
      private function onClickGains(_arg_1:MouseEvent) : void
      {
         var _local_2:MovieClip = _arg_1.currentTarget as MovieClip;
         _local_2.buttonMode = false;
         _local_2.removeEventListener(MouseEvent.CLICK,this.onClickGains);
         EventManager.dispatchEvent(new DynamicEvent("get_gains",_local_2.name));
      }
