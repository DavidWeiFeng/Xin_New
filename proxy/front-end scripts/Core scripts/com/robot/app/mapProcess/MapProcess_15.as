package com.robot.app.mapProcess
{
   ...
   public class MapProcess_15 extends BaseMapProcess
   {
      ...
      private function check() : void
      {
         ...
         {
            TasksManager.getProStatus(401,0,function(_arg_1:Boolean):void
            {
               if(!_arg_1)
               {
      ...
      private function onPaoClick(_arg_1:MouseEvent) : void
      {
      ...
      private function onMusicClick(e:MouseEvent) : void
      {
         ...
         TasksManager.complete(401,0,function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
      ...
      public function monkeyFun() : void
      {
         ...
         var _local_4:int = 0;
         var _local_2:Array = [7,8,9,307,308,309];
         ...
         {
            _local_1 = "你还没有领取" + TextFormatUtil.getRedTxt("小火猴的武学梦想") + "任务呢，" + "快点击右上角的" + TextFormatUtil.getRedTxt("精灵训练营") + "按钮看看吧！";
            Alarm.show(_local_1);
            return;
         }
         var _local_3:PetModel = MainManager.actorModel.pet;
         if(!_local_3)
         {
         ...
         {
            if(_local_3.info.petID == _local_2[_local_4])
            {
