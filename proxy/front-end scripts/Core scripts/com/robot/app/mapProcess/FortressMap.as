package com.robot.app.mapProcess
{
   ...
   public class FortressMap extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         {
            _local_1 = uint(MainManager.actorInfo.teamInfo.priv);
      ...
      private function onChangeHandler(_arg_1:SocketEvent) : void
      {
         var _local_2:ByteArray = _arg_1.data as ByteArray;
         var _local_3:Number = _local_2.readUnsignedInt();
         MainManager.actorInfo.teamInfo.canExContribution += _local_3;
         MainManager.actorInfo.teamInfo.allContribution += _local_3;
      ...
      private function boundsBtn(_arg_1:Point) : void
      {
         ...
         DisplayUtil.align(this._teamContributeMc,null,AlignType.MIDDLE_RIGHT,_arg_1);
      ...
      private function onInfo(_arg_1:MouseEvent) : void
      {
      ...
      private function onEdie(_arg_1:MouseEvent) : void
      {
      ...
      private function onReAll(_arg_1:MouseEvent) : void
      {
         ArmManager.removeAllInMap();
      }
      
      private function onMember(_arg_1:MouseEvent) : void
      {
