package com.robot.app.mapProcess
{
   ...
   public class MapProcess_52 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         this._flower.addEventListener(MouseEvent.ROLL_OVER,function(_arg_1:MouseEvent):void
         {
            _flower.gotoAndStop(2);
         });
         this._flower.addEventListener(MouseEvent.ROLL_OUT,function(_arg_1:MouseEvent):void
         {
      ...
      private function qimiHandler(_arg_1:Event) : void
      {
      ...
      private function nonoMateChange(_arg_1:SocketEvent) : void
      {
      ...
      private function timerEnterHandler(_arg_1:TimerEvent) : void
      {
         ++this.an;
         if(this.an >= 60)
         {
      ...
      private function nonoMcEnterFrame(_arg_1:Event) : void
      {
      ...
      private function clickTreeHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function reIntball() : void
      {
         ...
         var _local_1:uint = 0;
         var _local_4:uint = 0;
         _local_2 = new Array(0,1,2,3,4,5);
         var _local_3:Array = new Array();
         while(_local_4 < 2)
         {
            _local_1 = uint(Math.random() * _local_2.length);
            _local_3.push(_local_2[_local_1]);
            _local_2.splice(_local_1,1);
            _local_4++;
         }
         this._bao_0 = conLevel["bao_" + _local_3[0]];
         this._bao_1 = conLevel["bao_" + _local_3[1]];
         this._btn_0 = conLevel["btn_" + _local_3[0]];
         this._btn_1 = conLevel["btn_" + _local_3[1]];
         this._b_0 = conLevel["b_" + _local_3[0]];
         this._b_1 = conLevel["b_" + _local_3[1]];
         this._bao_0.gotoAndStop(1);
         this._bao_1.gotoAndStop(1);
         this._btn_0.visible = true;
         this._btn_1.visible = true;
         conLevel["bao_" + _local_2[0]].gotoAndStop(5);
         conLevel["bao_" + _local_2[1]].gotoAndStop(5);
         conLevel["bao_" + _local_2[2]].gotoAndStop(5);
         conLevel["bao_" + _local_2[3]].gotoAndStop(5);
         conLevel["btn_" + _local_2[0]].visible = false;
         conLevel["btn_" + _local_2[1]].visible = false;
         conLevel["btn_" + _local_2[2]].visible = false;
         conLevel["btn_" + _local_2[3]].visible = false;
      ...
      private function clickB0Handler(_arg_1:MouseEvent) : void
      {
         this._b_0.removeEventListener(MouseEvent.CLICK,this.clickB0Handler);
      ...
      private function clickB1Handler(_arg_1:MouseEvent) : void
      {
         this._b_1.removeEventListener(MouseEvent.CLICK,this.clickB1Handler);
      ...
      private function getBears(type:uint, str:String, n:uint) : void
      {
         ...
         a.sendToServer(function(_arg_1:DayTalkInfo):void
         {
            NpcTipDialog.show("你得到了" + _arg_1.outCount + "颗" + str + "。" + str + "已经放入你的背包里了。",null,NpcTipDialog.NONO,-80);
         });
      }
      
      private function oneClickHandler(_arg_1:MouseEvent) : void
      {
         this._btn_1.removeEventListener(MouseEvent.CLICK,this.oneClickHandler);
      ...
      private function zeroClickHandler(_arg_1:MouseEvent) : void
      {
         this._btn_0.removeEventListener(MouseEvent.CLICK,this.zeroClickHandler);
