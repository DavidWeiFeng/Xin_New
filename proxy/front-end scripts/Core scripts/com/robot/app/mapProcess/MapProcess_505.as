package com.robot.app.mapProcess
{
   ...
   public class MapProcess_505 extends BaseMapProcess
   {
      
      private var _petBoard:MovieClip;
      
      private var _petMc:MovieClip;
      
      private var _point:Point = new Point(480,345);
      
      private var _scaleNum:Number = 1.8;
      
      public function MapProcess_505()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         this._petBoard = conLevel["signboard"];
         this._petBoard.gotoAndStop(DarkPortalModel.doorIndex);
