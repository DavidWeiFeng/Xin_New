package com.robot.app.mapProcess
{
   ...
   public class MapProcess_40 extends BaseMapProcess
   {
      ...
      private function onOverAkxy(_arg_1:MouseEvent) : void
      {
         var _local_2:Sound = MapLibManager.getSound("akxy_sound");
         _local_2.play(0,1);
      }
      
      private function onWBTimer(_arg_1:TimerEvent) : void
      {
      }
      ...
      private function onChangeCloth(_arg_1:Event = null) : void
      {
      ...
      public function changeMap(o:MovieClip) : void
      {
         ...
         {
            mode.mask = shape;
            var _local_1:Number = mode.y + 200;
      ...
      {
         TasksManager.complete(8,2,function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
      ...
      public function onShouHit() : void
      {
         ...
         {
            NpcTipDialog.show("我是骄阳计划的" + TextFormatUtil.getRedTxt(MainManager.actorInfo.nick) + "，跟着求救信号找来的。你说的海盗是不是独眼的，紫色的？",function():void
            {
