package com.robot.app.mapProcess
{
   ...
   public class MapProcess_501 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         while(_local_2 < 5)
         {
            _local_1 = conLevel["btn" + _local_2];
      ...
      override public function destroy() : void
      {
         ...
         {
            _local_1 = conLevel["btn" + _local_2];
            _local_1.removeEventListener(MouseEvent.CLICK,this.onBtnClickHandler);
            _local_2++;
         }
      ...
      private function onBtnClickHandler(_arg_1:MouseEvent) : void
      {
         ...
         conLevel["light_" + uint(_local_2.name.substr(-1,1))].visible = false;
         ++this.clickCount;
      ...
      private function onPillarMCFrameHandler(_arg_1:Event) : void
      {
      ...
      private function onMirrorDownMCFrameHandler(_arg_1:Event) : void
      {
      ...
      private function onMirrorUpMCFrameHandler(_arg_1:Event) : void
      {
      ...
      private function onShootMCFrameHandler(_arg_1:Event) : void
      {
      ...
      private function onShootMCHandler(_arg_1:MouseEvent) : void
      {
         this.shootMC.gotoAndPlay("fire");
         this.shootMC.addEventListener(Event.ENTER_FRAME,this.onShootMCFrameHandler);
      }
      
      private function onShootOverHandler(_arg_1:MouseEvent) : void
      {
         this.shootMC.gotoAndPlay(1);
      }
      
      private function onMirrorMCHandler(_arg_1:MouseEvent) : void
      {
         var _local_2:MovieClip = _arg_1.currentTarget as MovieClip;
         switch(_local_2.currentLabel)
         {
            case "up":
               _local_2.gotoAndStop("horiz");
               return;
            case "horiz":
               _local_2.gotoAndStop("down");
               return;
            case "down":
               _local_2.gotoAndStop("up");
               return;
            case "upstate":
               _local_2.gotoAndStop("horiz");
               return;
      ...
      private function onBridgeMCHandler(_arg_1:MouseEvent) : void
      {
      }
   }
}
