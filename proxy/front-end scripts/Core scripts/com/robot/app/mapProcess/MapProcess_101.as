package com.robot.app.mapProcess
{
   ...
   public class MapProcess_101 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         {
            TasksManager.getProStatusList(89,function(_arg_1:Array):void
            {
               if(!_arg_1[0] || _arg_1[0] && !_arg_1[1])
               {
      ...
      public function hitNpc() : void
      {
         ...
         if(!this.teamPanel)
         {
            ...
            joinTeam.addEventListener(MouseEvent.CLICK,function(_arg_1:MouseEvent):void
            {
            ...
            createTeam.addEventListener(MouseEvent.CLICK,function(_arg_1:MouseEvent):void
            {
      ...
      private function testsHander(_arg_1:Event) : void
      {
         var _local_2:uint = uint(MainManager.actorInfo.curFreshStage);
         var _local_3:uint = Math.max(MainManager.actorInfo.curFreshStage,MainManager.actorInfo.maxFreshStage);
         if(_local_3 >= 10)
         {
      ...
      private function com1(b1:Boolean) : void
      {
         if(b1)
         {
            TasksManager.complete(89,0,function(b1:Boolean):void
            {
               if(b1)
               {
                  TasksManager.complete(89,1,function(_arg_1:Boolean):void
                  {
                     if(_arg_1)
                     {
      ...
      private function onOverHnalder(_arg_1:MouseEvent) : void
      {
         conLevel["clothMc"].gotoAndStop(2);
      }
      
      private function onOutHnalder(_arg_1:MouseEvent) : void
      {
         conLevel["clothMc"].gotoAndStop(1);
      }
      
      private function onArmExcBookHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function clickBlueBtn(_arg_1:MouseEvent) : void
      {
         ItemAction.buyMultiItem(4,"蓝宝石套装",100233,100234,100235,100236);
      }
      
      private function clickRedBtn(_arg_1:MouseEvent) : void
      {
      ...
      private function onInstructorHandler(_arg_1:Event) : void
      {
         this.showTask();
      }
      ...
      private function onArmBookHandler(_arg_1:MouseEvent) : void
      {
