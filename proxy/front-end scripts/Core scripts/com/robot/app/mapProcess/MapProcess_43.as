   ...
   public class MapProcess_43 extends BaseMapProcess
   {
      ...
      private function cheak() : void
      {
         if(TasksManager.isComNoviceTask())
         {
            ...
            TasksManager.getProStatus(8,0,function(_arg_1:Boolean):void
            {
               if(!_arg_1)
               {
      ...
      private function onMusicClick(_arg_1:MouseEvent) : void
      {
      ...
      private function onBoxTimer(_arg_1:TimerEvent) : void
      {
      ...
      {
         TasksManager.complete(8,6,function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
               showBook();
      ...
      private function onPicBookClose(_arg_1:Event) : void
      {
         this._xitaNpc.mouseEnabled = false;
      ...
      {
         NpcTipDialog.show("我带你回骄阳计划吧，博士肯定能把你修复的。",this.dia3,NpcTipDialog.SEER_SAD);
      }
      ...
      public function showXita() : void
      {
         ...
         if(TasksManager.getTaskStatus(8) == TasksManager.UN_ACCEPT)
         {
            ...
            {
               TasksManager.accept(8,function(_arg_1:Boolean):void
               {
                  if(_arg_1)
                  {
