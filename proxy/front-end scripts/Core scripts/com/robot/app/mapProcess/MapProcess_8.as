package com.robot.app.mapProcess
{
   ...
   public class MapProcess_8 extends BaseMapProcess
   {
      ...
      private function clickElietCoinHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function onShopHandler(_arg_1:MouseEvent) : void
      {
         this.showShopBook();
      }
      ...
      private function showDialog(_arg_1:TimerEvent) : void
      {
      ...
      private function openRepair(_arg_1:MouseEvent) : void
      {
         if(!this.repairPanel)
         {
      ...
      public function buyHandler(_arg_1:MouseEvent = null) : void
      {
      ...
      public function onFireHandler(e:MouseEvent) : void
      {
         ...
         {
            var _local_1:HOTestTask = new HOTestTask();
      ...
      public function onShipHandler(e:MouseEvent) : void
      {
         ...
         {
            var _local_1:BatteryTestTask = new BatteryTestTask();
         },NpcTipDialog.CICI,-60);
      }
      
      private function clickMachCloseHandler(_arg_1:MouseEvent = null) : void
      {
         DisplayUtil.removeForParent(this._machPanel);
      }
      
      public function showWaterGame(_arg_1:MouseEvent) : void
      {
         this.clickMachCloseHandler();
      ...
      private function initTask_94() : void
      {
         ...
         {
            TasksManager.getProStatusList(94,function(_arg_1:Array):void
            {
               if(!_arg_1[0])
               {
                  onAcceptTask();
      ...
      private function onAcceptTask(evt:TaskEvent = null) : void
      {
         ...
         this.drillInBagMC.addEventListener(Event.ENTER_FRAME,function(_arg_1:Event):void
         {
      ...
      private function onHasClothOne(_arg_1:ItemEvent) : void
      {
      ...
      private function onGetItemOne(_arg_1:DynamicEvent) : void
      {
         if(uint(_arg_1.paramObject) == 100014)
         {
