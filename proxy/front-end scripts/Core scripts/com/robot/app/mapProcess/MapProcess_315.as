package com.robot.app.mapProcess
{
   ...
   public class MapProcess_315 extends BaseMapProcess
   {
      ...
      private function shouEnterFrameHandler(_arg_1:Event) : void
      {
      ...
      private function showShouPet(_arg_1:int, _arg_2:int) : void
      {
         topLevel["m" + _arg_1].visible = true;
         if(_arg_2 == 0)
         {
            DisplayUtil.FillColor(topLevel["m" + _arg_1],16711680);
         }
         else
         {
            DisplayUtil.FillColor(topLevel["m" + _arg_1],16777215);
         }
      }
      ...
      {
         var _local_1:uint = 0;
         for each(_local_1 in this.clothesArr)
         {
            if(_local_1 == 100162)
            {
               if(Boolean(this.pet0))
      ...
      public function onChangeMap(mc:MovieClip) : void
      {
         ...
         this.door_effect.addEventListener(Event.ENTER_FRAME,function(evt:Event):void
         {
...
class Carver
{
   ...
   public function Carver(_arg_1:BaseMapProcess)
   {
      super();
      this.map = _arg_1;
         ...
         if(info.superNono)
         {
            ...
            supNonoColorMC.addEventListener(Event.ENTER_FRAME,function(evt:Event):void
            {
               if(supNonoColorMC.currentFrame == supNonoColorMC.totalFrames)
               {
                  ...
                  openDoorMC.addEventListener(Event.ENTER_FRAME,function(_arg_1:Event):void
                  {
