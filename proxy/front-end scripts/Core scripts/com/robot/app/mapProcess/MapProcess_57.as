package com.robot.app.mapProcess
{
   ...
   public class MapProcess_57 extends BaseMapProcess
   {
      ...
      private function clickHuaHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function clickPetHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function initTask81() : void
      {
         ...
         TasksManager.getProStatusList(TaskController_81.TASK_ID,function(_arg_1:Array):void
         {
            if(!_arg_1[0])
            {
            ...
            else if(Boolean(_arg_1[0]) && !_arg_1[1])
            {
            ...
            else if(Boolean(_arg_1[2]) && !_arg_1[3])
            {
