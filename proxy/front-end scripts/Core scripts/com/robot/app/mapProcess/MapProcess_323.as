package com.robot.app.mapProcess
{
   ...
   public class MapProcess_323 extends BaseMapProcess
   {
      ...
      private function onClickQishi(evt:MouseEvent) : void
      {
      ...
      private function onFightDululu(evt:MouseEvent) : void
      {
      ...
      private function onFightDululuClose(evt:PetFightEvent) : void
      {
