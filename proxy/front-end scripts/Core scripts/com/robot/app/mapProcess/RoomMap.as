package com.robot.app.mapProcess
{
   ...
   public class RoomMap extends BaseMapProcess
   {
      ...
      private function doorplateShow(ui:Sprite) : void
      {
         if(Boolean(ui))
         {
            this._doorplate = ui;
            ...
            ui["txt"].text = "";
            UserInfoManager.seeOnLine([MainManager.actorInfo.mapID],function(arr:Array):void
            {
               if(arr.length == 0)
               {
               ...
               {
                  UserInfoManager.getInfo(arr[0].userID,function(_arg_1:UserInfo):void
                  {
                     ui["txt"].text = _arg_1.nick;
                  });
               }
      ...
      private function onDoorPlateInfo(_arg_1:MouseEvent) : void
      {
      ...
      private function onPetStorage(_arg_1:MouseEvent) : void
      {
