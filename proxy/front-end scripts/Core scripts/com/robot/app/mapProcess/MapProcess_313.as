package com.robot.app.mapProcess
{
   ...
   public class MapProcess_313 extends BaseMapProcess
   {
      ...
      private function onStartDragStelae(_arg_1:MouseEvent) : void
      {
         var _local_2:MovieClip = _arg_1.currentTarget as MovieClip;
         _local_2.removeEventListener(MouseEvent.CLICK,this.onStartDragStelae);
         _local_2.addEventListener(Event.ENTER_FRAME,this.dragStelea);
         _local_2.mouseChildren = false;
         this.clickStelae = _local_2;
         _local_2.addEventListener(MouseEvent.CLICK,this.onHitZhuzi);
      }
      
      private function dragStelea(_arg_1:Event) : void
      {
         var _local_2:MovieClip = _arg_1.currentTarget as MovieClip;
         _local_2.x = LevelManager.stage.mouseX;
         _local_2.y = LevelManager.stage.mouseY + 60;
      }
      
      private function onHitZhuzi(_arg_1:MouseEvent) : void
      {
         var _local_2:MovieClip = _arg_1.currentTarget as MovieClip;
         _local_2.removeEventListener(MouseEvent.CLICK,this.onHitZhuzi);
         ...
         else
         {
            ...
            MapManager.currentMap.controlLevel.addChildAt(_local_2,this.mcDepth);
      ...
      private function onActorEntFrame(_arg_1:Event) : void
      {
