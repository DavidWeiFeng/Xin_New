package com.robot.app.mapProcess
{
   ...
   public class MapProcess_303 extends BaseMapProcess
   {
      ...
      private function onClickAxle(_arg_1:MouseEvent) : void
      {
         this.clickAxle = _arg_1.currentTarget as MovieClip;
      ...
      private function onTimer_0(_arg_1:TimerEvent) : void
      {
         if(this.count_0 >= 5)
         {
      ...
      private function onTimer_1(_arg_1:TimerEvent) : void
      {
         if(this.count_1 >= 5)
         {
      ...
      private function onTimer_0_Comp(_arg_1:TimerEvent) : void
      {
         this.timer_0.stop();
         this.count_0 = 0;
      ...
      private function onTimer_1_Comp(_arg_1:TimerEvent) : void
      {
         this.timer_1.stop();
         this.count_1 = 0;
      ...
      private function check() : void
      {
         ...
         for each(_local_1 in this.checkArr)
         {
            if(_local_1 == false)
            {
               return;
      ...
      private function onGetChests(_arg_1:MouseEvent) : void
      {
