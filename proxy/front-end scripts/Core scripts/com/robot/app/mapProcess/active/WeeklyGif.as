package com.robot.app.mapProcess.active
{
   ...
   public class WeeklyGif
   {
      ...
      public static function setup(_arg_1:MovieClip) : void
      {
         _btn = _arg_1;
         _btn.buttonMode = true;
         _btn.addEventListener(MouseEvent.CLICK,clickHandler);
         var _local_2:DayOreCount = new DayOreCount();
         _local_2.addEventListener(DayOreCount.countOK,onCount2);
         _local_2.sendToServer(100);
      }
      ...
      private static function onTalk2(_arg_1:SocketEvent) : void
      {
      ...
      private static function onCount2(_arg_1:Event) : void
      {
