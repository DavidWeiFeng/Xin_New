package com.robot.app.mapProcess
{
   ...
   public class MapProcess_22 extends BaseMapProcess
   {
      ...
      private function chack() : void
      {
         ...
         {
            TasksManager.getProStatus(401,3,function(_arg_1:Boolean):void
            {
               if(!_arg_1)
               {
         ...
         if(TasksManager.getTaskStatus(404) == TasksManager.ALR_ACCEPT)
         {
            TasksManager.getProStatus(404,0,function(_arg_1:Boolean):void
            {
               if(_arg_1)
               {
            ...
            TasksManager.getProStatus(404,1,function(_arg_1:Boolean):void
            {
               if(_arg_1)
               {
      ...
      private function onShowYiyouPanel(_arg_1:MouseEvent) : void
      {
         if(TasksManager.getTaskStatus(404) == TasksManager.COMPLETE)
         {
            this._slopsAMC.removeEventListener(MouseEvent.CLICK,this.onShowYiyouPanel);
      ...
      private function onBeikeClick(_arg_1:MouseEvent) : void
      {
      ...
      public function onMusicHit() : void
      {
         ...
         TasksManager.complete(401,2,function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
