package com.robot.app.mapProcess
{
   ...
   public class MapProcess_322 extends BaseMapProcess
   {
      ...
      private function onShotGrape(evt:AimatEvent) : void
      {
         ...
         if(this.grapeMC.hitTestPoint(info.endPos.x,info.endPos.y))
         {
            ...
            {
               NpcDialog.show(NPC.SEER,["如果推算没有错，这里应该就是黑色旋涡产生的原因所在！但是……为什么没有线索啊？#7先把这个胡子洋葱头带回骄阳计划让博士看看吧……也许他会知道点什么！"],["事不宜迟！我们这就回骄阳计划实验室！"],[function():void
               {
      ...
      private function showTaskPanelComp_3(_arg_1:DynamicEvent) : void
      {
         EventManager.removeEventListener("taskPanel_3_close",this.showTaskPanelComp_3);
         TasksManager.complete(95,2,null,true);
      }
      
      private function showTaskPanelComp_5(evt:DynamicEvent) : void
      {
         var url:String = null;
      ...
      private function showTaskPanelComp_6(evt:DynamicEvent) : void
      {
