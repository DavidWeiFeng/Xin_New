package com.robot.app.freshFightLevel
{
   ...
   public class FightLevelModel
   {
      ...
      private static const _maxLevel:uint = 600;
      ...
      private static function upDatahandler() : void
      {
         ...
         while(_local_3 < xml.level.length())
         {
            ...
            else
            {
               ...
               {
                  _local_2 = uint(uint(MainManager.actorInfo.maxFreshStage / 10));
               }
               else
               {
                  _local_2 = uint(uint(uint(MainManager.actorInfo.maxFreshStage / 10) + 1));
               }
