package com.robot.app.im.ui
{
   ...
   public class IMListItem extends Sprite
   {
      ...
      private function clickTeacherIcon(_arg_1:MouseEvent) : void
      {
      ...
      private function clickStudentIcon(_arg_1:MouseEvent) : void
      {
      ...
      protected function onTalk(_arg_1:MouseEvent) : void
      {
