package com.robot.app.im
{
   ...
   public class AddFriendMsgController
   {
      ...
      public static function showInviteTeamPanel(_arg_1:Boolean = true) : void
      {
         if(_teamPanel == null)
         {
         ...
         _teamPanel.setup();
         _teamPanel.init(_arg_1);
         _teamPanel.show();
      }
      
      public static function showAddFridPanel(_arg_1:Boolean = false) : void
      {
         if(_panel == null)
         {
