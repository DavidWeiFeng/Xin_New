package com.robot.app.buyItem
{
   ...
   public class ArmAction
   {
      ...
      public static function buyItem(id:uint, isTip:Boolean = true) : void
      {
         var price:uint = 0;
         ...
         if(price > 0)
         {
            str = TextFormatUtil.getRedTxt(name) + "需要花费" + price.toString() + "个骄阳豆，" + "你现在拥有" + MainManager.actorInfo.coins + "个骄阳豆，要确定购买吗？";
         }
         else
         {
