package com.robot.app.superParty
{
   ...
   public class SPChannelController
   {
      ...
      private static function onSwitchHandler(_arg_1:MapEvent) : void
      {
         mapID = _arg_1.mapModel.id;
         if(mapID == 52 || mapID == 316)
         {
            return;
         }
      ...
      private static function ondesHandler(_arg_1:MapEvent) : void
      {
         MapManager.removeEventListener(MapEvent.MAP_DESTROY,ondesHandler);
         mapID = 0;
      }
      
      public static function initMC(_arg_1:MovieClip) : void
      {
         _m_3 = _arg_1;
      }
      
      public static function changeMap(_arg_1:uint) : void
      {
      ...
      private static function onSucHandler(_arg_1:MCLoadEvent) : void
      {
         _bounsMC = _arg_1.getContent() as MovieClip;
