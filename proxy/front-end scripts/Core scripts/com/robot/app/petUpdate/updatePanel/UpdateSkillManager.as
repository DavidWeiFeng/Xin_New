package com.robot.app.petUpdate.updatePanel
{
   ...
   public class UpdateSkillManager
   {
      ...
      public static function update(_arg_1:UpdateSkillInfo, _arg_2:Function) : void
      {
         _info = _arg_1;
         _fun = _arg_2;
         execute();
      ...
      private static function showSinglePanel() : void
      {
         ...
         var _local_1:uint = uint(_info.activeSkills.shift());
         singlePanel.setInfo(_info.petCatchTime,_local_1,PetManager.getPetInfo(_info.petCatchTime) != null);
         DisplayUtil.align(singlePanel,null,AlignType.MIDDLE_CENTER);
         MainManager.getStage().addChild(singlePanel);
      }
      
      private static function onCloseSingle(_arg_1:Event) : void
      {
      ...
      private static function showMultiPanel() : void
      {
         ...
         var _local_1:uint = uint(_info.unactiveSkills.shift());
         multiPanel.setInfo(_info.petCatchTime,_local_1,PetManager.getPetInfo(_info.petCatchTime) != null);
         DisplayUtil.align(multiPanel,null,AlignType.MIDDLE_CENTER);
         MainManager.getStage().addChild(multiPanel);
      }
      
      private static function onCloseMulti(_arg_1:Event) : void
      {
