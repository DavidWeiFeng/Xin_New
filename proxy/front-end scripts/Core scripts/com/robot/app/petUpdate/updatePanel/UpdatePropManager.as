package com.robot.app.petUpdate.updatePanel
{
   ...
   public class UpdatePropManager
   {
      ...
      public static function update(_arg_1:UpdatePropInfo, _arg_2:PetInfo, _arg_3:Function, _arg_4:Boolean = false) : void
      {
         _fun = _arg_3;
         _newInfo = _arg_1;
         _oldInfo = _arg_2;
         if(_newInfo.level > _oldInfo.level || _arg_4)
         {
            updateLevel();
         }
      ...
      private static function updateLevelCloseHandler(_arg_1:Event) : void
      {
         if(_fun != null)
         {
            _fun();
      ...
      private static function updateNormalCloseHandler(_arg_1:Event) : void
      {
         if(_fun != null)
         {
            _fun();
