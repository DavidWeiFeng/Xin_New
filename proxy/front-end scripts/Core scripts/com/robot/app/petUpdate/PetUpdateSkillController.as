package com.robot.app.petUpdate
{
   ...
   public class PetUpdateSkillController
   {
      ...
      private function onPetUpdateSkill(_arg_1:PetFightEvent) : void
      {
      ...
      public function setup(_arg_1:PetUpdateSkillInfo) : void
      {
         infoArray = [];
         infoArray = infoArray.concat(_arg_1.infoArray);
      }
      
      private function show() : void
      {
         var _local_1:UpdateSkillInfo = infoArray.shift() as UpdateSkillInfo;
         UpdateSkillManager.update(_local_1,this.closeHandler);
      }
