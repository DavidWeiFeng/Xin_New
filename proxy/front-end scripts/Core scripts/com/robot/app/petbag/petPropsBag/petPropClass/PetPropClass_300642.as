package com.robot.app.petbag.petPropsBag.petPropClass
{
   ...
   public class PetPropClass_300642
   {
      
      public function PetPropClass_300642(param1:PetPropInfo)
      {
         super();
         ...
         {
            SocketConnection.send(CommandID.USE_PET_ITEM_FULL_ABILITY_OF_STUDY,param1.petInfo.catchTime,4,param1.itemId,0);
         }
      }
   }
}
