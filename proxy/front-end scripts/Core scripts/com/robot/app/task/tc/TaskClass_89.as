package com.robot.app.task.tc
{
   ...
   public class TaskClass_89
   {
      ...
      public function TaskClass_89(info:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(89,TasksManager.COMPLETE);
         TaskController_89.destroy();
         MainManager.actorInfo.coins += 1000;
         NpcDialog.show(NPC.LYMAN,["哈哈！不错啊！果然青出于蓝胜于蓝！你和你的精灵伙伴都做的很棒！骄阳计划的旅程才刚刚开始，你可能会经历更多的磨练和考验哦！"],["我会以最佳的状态迎接新的挑战！"],[function():void
         {
            Alarm.show("<font color=\'#ff0000\'>500积累经验</font>已经存入你的经验分配器中。",function():void
            {
               Alarm.show("<font color=\'#ff0000\'>" + 1000 + "个骄阳豆" + "</font>已放入了你的储存箱。",function():void
               {
