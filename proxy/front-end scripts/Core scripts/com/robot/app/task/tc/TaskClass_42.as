package com.robot.app.task.tc
{
   ...
   public class TaskClass_42
   {
      ...
      public function TaskClass_42(_arg_1:NoviceFinishInfo)
      {
         super();
         MainManager.actorInfo.coins += 3000;
         PetInStorageAlert.show(_arg_1.petID,"卡塔已经放入了你的精灵仓库。",null,this.showTip);
      }
      ...
      private function showTip() : void
      {
         ...
         {
            ItemInBagAlert.show(1,"<font color=\'#ff0000\'>" + 3000 + "</font>个骄阳豆已放入了你的储存箱。",function():void
            {
