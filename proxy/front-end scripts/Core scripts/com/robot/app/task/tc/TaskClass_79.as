package com.robot.app.task.tc
{
   ...
   public class TaskClass_79
   {
      
      public function TaskClass_79(_arg_1:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(79,TasksManager.COMPLETE);
         MainManager.actorInfo.coins += 2000;
         Alarm.show("<font color=\'#ff0000\'>3000积累经验</font>已经存入你的经验分配器中。",this.showTip);
      }
      
      private function showTip() : void
      {
         ItemInBagAlert.show(1,"<font color=\'#ff0000\'>" + 2000 + "</font>个骄阳豆已放入了你的储存箱。",this.addOverUI);
      }
