package com.robot.app.task.tc
{
   ...
   public class TaskClass_31
   {
      ...
      public function TaskClass_31(_arg_1:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(31,TasksManager.COMPLETE);
         TaskController_31.delIcon();
         NpcTipDialog.show("现在，为你传送去的是<font color=\'#ff0000\'>赛尔特攻队服</font>。为了接下来的战斗，只有拥有最好的装备才能有最佳的战斗状态。",this.receiveReward,NpcTipDialog.INSTRUCTOR,0,this.receiveReward);
      }
