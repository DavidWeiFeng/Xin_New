package com.robot.app.task.tc
{
   ...
   public class TaskClass_303
   {
      
      public function TaskClass_303(_arg_1:NoviceFinishInfo)
      {
         var _local_2:Object = null;
         var _local_3:String = null;
         super();
         TasksManager.setTaskStatus(303,TasksManager.COMPLETE);
         HuLiAo.bFirstWin = true;
