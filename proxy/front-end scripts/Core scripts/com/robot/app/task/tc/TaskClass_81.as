package com.robot.app.task.tc
{
   ...
   public class TaskClass_81
   {
      
      public function TaskClass_81(_arg_1:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(81,TasksManager.COMPLETE);
      ...
      {
         ItemInBagAlert.show(1,"<font color=\'#ff0000\'>" + 1000 + "</font>个骄阳豆已放入了你的储存箱。",this.addOverUI);
      }
