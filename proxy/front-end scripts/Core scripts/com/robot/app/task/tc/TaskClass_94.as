package com.robot.app.task.tc
{
   ...
   public class TaskClass_94
   {
      ...
      public function TaskClass_94(info:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(94,TasksManager.COMPLETE);
         MainManager.actorInfo.coins += 2000;
         NpcDialog.show(NPC.CICI,["哇！你竟然这么快采集到了黄晶矿和甲烷气！这些可都是我们骄阳计划上的重要能源哦！我想你应该多储备一些，以后很多地方都会利用到它们！"],["好的！我知道了!"],[function():void
         {
            NpcDialog.show(NPC.CICI,["另外，你在其他星球上还会发现很多新型的矿石，有些还需要用0xff0000电能锯子0xffffff才能切割下来。"],["电能锯子？去哪弄呢？"],[function():void
            {
               NpcDialog.show(NPC.CICI,["那可不是骄阳豆可以购买到的工具哦！通过0xff0000赫尔卡星0xffffff的拆弹考验才能获得它！好吧，我就说到这里咯，这是给你的小礼物呢！快打开看看吧！#1"],["会是什么样的礼物呢？"],[function():void
               {
                  Alarm.show("<font color=\'#ff0000\'>500积累经验</font>已经存入你的经验分配器中。",function():void
                  {
                     ItemInBagAlert.show(1,"<font color=\'#ff0000\'>" + 1000 + "</font>个骄阳豆已放入了你的储存箱。",function():void
                     {
