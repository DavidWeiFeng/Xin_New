package com.robot.app.task.tc
{
   ...
   public class TaskClass_33
   {
      ...
      public function TaskClass_33(_arg_1:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(33,TasksManager.COMPLETE);
         TaskController_33.delIcon();
         var _local_2:String = "宇宙海盗被我们赶走了，但是赛尔们不要掉以轻心，" + "他们还像毒刺一样深深扎在美丽的宇宙当中，现在先让我来奖励完成任务的小英雄吧！";
         NpcTipDialog.show(_local_2,this.getReward,NpcTipDialog.INSTRUCTOR,0,this.getReward);
      }
