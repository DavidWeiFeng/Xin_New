package com.robot.app.task.tc
{
   ...
   public class TaskClass_98
   {
      ...
      public function TaskClass_98(info:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(98,TasksManager.COMPLETE);
         TaskController_98.destroy();
         MainManager.actorInfo.coins += 1000;
         NpcDialog.show(NPC.NIBU,["我最最幸福的就是能够来到骄阳计划，能够感受到小赛尔们对我的关心！谢谢你们……"],["傻瓜！这都是我们应该的嘛！"],[function():void
         {
            Alarm.show("<font color=\'#ff0000\'>2000积累经验</font>已经存入你的经验分配器中。",function():void
            {
               Alarm.show("<font color=\'#ff0000\'>1000个骄阳豆</font>已放入了你的储存箱。",function():void
               {
