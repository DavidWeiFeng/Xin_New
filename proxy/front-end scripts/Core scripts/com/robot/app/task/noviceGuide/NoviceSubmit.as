package com.robot.app.task.noviceGuide
{
   ...
   public class NoviceSubmit
   {
      ...
      public static function set outId(_arg_1:uint) : void
      {
         _outId = _arg_1;
      }
      ...
      private static function onComplete(_arg_1:SocketEvent) : void
      {
         taskOutInfo = _arg_1.data as NoviceFinishInfo;
