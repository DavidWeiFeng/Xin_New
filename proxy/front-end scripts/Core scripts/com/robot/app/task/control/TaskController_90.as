package com.robot.app.task.control
{
   ...
   public class TaskController_90
   {
      ...
      public static function catchPetEnd() : void
      {
         ...
         TasksManager.getProStatusList(TASK_ID,function(_arg_1:Array):void
         {
      ...
      public static function openPetBook(_arg_1:uint = 0) : void
      {
         _isEnd = _arg_1;
      ...
      private static function clickdownHandler(_arg_1:MouseEvent) : void
      {
         clearInterval(_showInlTime);
         MainManager.getStage().removeEventListener(MouseEvent.CLICK,clickdownHandler);
         _pipi_pic.x = 2000;
      ...
      public static function initFun(_arg_1:Function, _arg_2:MovieClip, _arg_3:MovieClip) : void
      {
         _pipi_mc = _arg_2;
         delAdd = _arg_1;
         _pipi_pic = _arg_3;
      ...
      private static function showTalk() : void
      {
         ...
         {
            TasksManager.accept(TASK_ID,function(_arg_1:Boolean):void
            {
               if(_arg_1)
               {
                  showPanel();
