package com.robot.app.task.control
{
   ...
   public class TaskController_79
   {
      ...
      public static function initLong(_arg_1:MovieClip, _arg_2:MovieClip, _arg_3:SimpleButton, _arg_4:SimpleButton) : void
      {
         longMc = _arg_1;
         _long = _arg_2;
         btn = _arg_3;
      ...
      {
         TasksManager.getProStatusList(TASK_ID,function(arr:Array):void
         {
            if(!arr[0])
            {
      ...
      public static function playMovie(_arg_1:String) : void
      {
         var _local_2:MCLoader = new MCLoader(_arg_1,LevelManager.appLevel,1,"正在打开动画");
         _local_2.addEventListener(MCLoadEvent.SUCCESS,onLoadMovie);
         _local_2.doLoad();
      }
      
      private static function onLoadMovie(event:MCLoadEvent) : void
      {
