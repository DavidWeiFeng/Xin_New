...
{
   import com.robot.app.freshFightLevel.*;
   ...
   public class TaskController_89
   {
      ...
      public static function task89Hander(light:MovieClip) : void
      {
      ...
      public static function oneStage(light:MovieClip) : void
      {
         lightMC = light;
      ...
      {
         showPanel();
         var _local_1:uint = uint(TasksManager.getTaskStatus(89));
      }
