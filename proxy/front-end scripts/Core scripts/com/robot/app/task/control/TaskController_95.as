package com.robot.app.task.control
{
   ...
   public class TaskController_95
   {
      ...
      {
         var _local_1:String = "TaskPanel_" + TASK_ID;
         if(panel == null)
         {
            panel = new AppModel(ClientConfig.getTaskModule(_local_1),"正在打开任务信息");
            panel.setup();
         }
         panel.show();
      }
      ...
      public static function showTaskPanel(_arg_1:uint) : void
      {
         var _local_2:String = "TaskPanel0_" + TASK_ID;
         if(taskPanel != null)
         {
            taskPanel.destroy();
            taskPanel = null;
         }
         taskPanel = new AppModel(ClientConfig.getTaskModule(_local_2),"正在打开任务信息");
         taskPanel.init(_arg_1);
         taskPanel.show();
      }
   }
}
