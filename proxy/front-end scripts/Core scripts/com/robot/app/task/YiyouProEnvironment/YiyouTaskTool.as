package com.robot.app.task.YiyouProEnvironment
{
   ...
   public class YiyouTaskTool extends Sprite
   {
      ...
      private function check(_arg_1:uint) : Boolean
      {
         ...
         var _local_4:int = 0;
         var _local_2:Array = [4,5,6,304,305,306];
      ...
      private function removeEvent(_arg_1:Array) : void
      {
         ...
         for each(_local_2 in _arg_1)
         {
            if(_local_2 != null)
            {
               ...
               _local_2.removeEventListener(Event.ENTER_FRAME,this.onEntFrame);
               _local_2 = null;
            }
         }
         Mouse.show();
      ...
      private function onCleanerClick(_arg_1:MouseEvent) : void
      {
         this.removeEvent(this._eventArr);
      ...
      private function onMopClick(_arg_1:MouseEvent) : void
      {
         this.removeEvent(this._eventArr);
      ...
      private function onMopMosClick(_arg_1:MouseEvent) : void
      {
         if(this._mop != null)
         {
            this.removeEvent(this._eventArr);
      ...
      private function onDetergentClick(_arg_1:MouseEvent) : void
      {
         this.removeEvent(this._eventArr);
      ...
      private function onDetergentMosClick(_arg_1:MouseEvent) : void
      {
      ...
      private function onGumwaterClick(_arg_1:MouseEvent) : void
      {
         this.removeEvent(this._eventArr);
            ...
            if(mc != null)
            {
               if(this._gumwater.hitTestObject(mc))
               {
                  ...
                  TasksManager.getProStatus(404,0,function(b:Boolean):void
                  {
                     if(b)
                     {
                        TasksManager.complete(404,1,function(_arg_1:Boolean):void
                        {
      ...
      private function onEntFrame(_arg_1:Event) : void
      {
         Mouse.hide();
         (_arg_1.currentTarget as MovieClip).x = LevelManager.appLevel.mouseX;
         (_arg_1.currentTarget as MovieClip).y = LevelManager.appLevel.mouseY;
      }
         ...
         if(this._cleaner != null)
         {
            ...
            if(this._count == 2)
            {
               TasksManager.getProStatus(404,1,function(b:Boolean):void
               {
                  ...
                  if(b)
                  {
                     TasksManager.complete(404,0,function(_arg_1:Boolean):void
                     {
                        TasksManager.complete(404,2);
                        hide();
                        destory();
