package com.robot.app.task.makeBase
{
   ...
   public class MakeBase
   {
      ...
      private static function getStorageList(e:*) : void
      {
         ...
         while(i < array.length)
         {
            ...
            if(info.id == 500502)
            {
               TasksManager.getProStatus(TASK_ID,0,function(_arg_1:Boolean):void
               {
                  if(!_arg_1)
                  {
            ...
            {
               TasksManager.getProStatus(TASK_ID,2,function(_arg_1:Boolean):void
               {
                  if(!_arg_1)
                  {
            ...
            {
               TasksManager.getProStatus(TASK_ID,1,function(_arg_1:Boolean):void
               {
                  if(!_arg_1)
                  {
      ...
      private static function getSomeThing(_arg_1:CommandID) : void
      {
         getUsedlist();
      }
