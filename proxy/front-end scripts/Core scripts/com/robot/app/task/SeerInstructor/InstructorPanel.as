package com.robot.app.task.SeerInstructor
{
   ...
   public class InstructorPanel
   {
      ...
      private function closeHander(_arg_1:MouseEvent) : void
      {
         LevelManager.topLevel.removeChild(this.mainPanel);
         LevelManager.openMouseEvent();
      }
      
      private function onGetWasteOk(_arg_1:Event) : void
      {
      ...
      private function contains(_arg_1:String, _arg_2:String) : Boolean
      {
