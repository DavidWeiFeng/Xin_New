package com.robot.app.task.SeerInstructor
{
   ...
   import com.robot.app.teacherAward.*;
   ...
   public class InstructorDialog
   {
      ...
      {
         NpcDialog.show(NPC.LYMAN,["你好，我是骄阳计划的总教官雷蒙，我主要负责把新加入的小赛尔们训练成赛尔精英！我希望你可以通过报名考试来获得教官资格！"],["我这就报名考试！","我是来领取奖励的。","我希望可以和我的学员解除关系。"],[handler1,handler2,handler3]);
      }
      ...
      private static function signHander(_arg_1:MouseEvent = null) : void
      {
         SeerInstructorMain.talkToInstructor(true);
      }
      
      private static function awardHander(_arg_1:MouseEvent = null) : void
      {
      ...
      private static function removeHander(_arg_1:MouseEvent = null) : void
      {
