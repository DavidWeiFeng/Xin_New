package com.robot.app.task.SeerInstructor
{
   ...
   public class NewInstructorContoller
   {
      ...
      private static function clickIcon(_arg_1:MouseEvent) : void
      {
         if(!panel)
         {
      ...
      public static function fight() : void
      {
         ...
         TasksManager.getProStatus(TASK_ID,5,function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
      ...
      public static function chekWaste() : void
      {
         ...
         if(TasksManager.getTaskStatus(TASK_ID) == TasksManager.ALR_ACCEPT)
         {
            TasksManager.getProStatus(TASK_ID,pro,function(_arg_1:Boolean):void
            {
               MapManager.currentMap.controlLevel["wasteMC"].visible = !_arg_1;
            });
         }
      }
      ...
      public static function setWaste() : void
      {
         ...
         TasksManager.complete(TASK_ID,pro,function(_arg_1:Boolean):void
         {
            if(_arg_1)
            {
