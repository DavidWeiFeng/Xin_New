package com.robot.app.task.newNovice
{
   ...
   public class NewNoviceStepFourController
   {
      ...
      private static var DIA_1_A:Array = ["差点忘了提醒你，每期骄阳计划和星球上发生的故事都会记载在航行日志上。及时关注新闻你会有更多的收获哦！","养成良好的阅读习惯，你的探索才更有目的！有了目标，那就要学会如何前往目的地。看到左下角的星盘没？上面记录着骄阳计划的宇航图，通过它你就可以前往目前已经探知的星系星球了。","经历了种种学习和考验，你现在已经是名合格的飞船成员了，恭喜你！接下来的旅程会更精彩，学无止境，期待你成为骄阳计划一线探索员！"];
