package com.robot.app.npc.npcClass
{
   ...
   public class NpcClass_100 implements INpc
   {
      ...
      public function NpcClass_100(_arg_1:NpcInfo, _arg_2:DisplayObject)
      {
         super();
      ...
      {
         NpcDialog.show(this.npc.npcInfo.npcId,["骄阳计划果然名不虚传！这里有很多我未见过的资料数据呢！我可要多加学习……"],["我想挑战你！",this.npc.npcInfo.questionA],[function():void
         {
            NpcDialog.show(npc.npcInfo.npcId,["小赛尔，现在暂时不接受挑战哟~\r萨格罗斯不知道跑去哪里了……你能帮我找一下他吗？"],["我这就去找他！"]);
         },null]);
      }
