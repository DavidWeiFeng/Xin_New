package com.robot.app.npc.npcClass
{
   ...
   public class NpcClass_7 implements INpc
   {
      ...
      public function NpcClass_7(_arg_1:NpcInfo, _arg_2:DisplayObject)
      {
         super();
      ...
      private function onClickNpc(e:NpcEvent) : void
      {
                           ...
                           NpcTipDialog.show("这里究竟发生了什么？为什么我看不到其他赫尔卡星人呢？",function():void
                           {
                              NpcTipDialog.show("失控的机械巨人和叛变的机械精灵已经完全失去控制了，还包围了我们的逃离飞船！\r我的赫尔卡星人民还等着我把他们救出来……",function():void
                              {
                                 NpcTipDialog.show("我愿意帮你营救他们！",function():void
                                 {
                                    ...
                                    {
                                       NpcTipDialog.show("当然愿意！我们骄阳计划有位全宇宙最厉害的精灵博士，他一定能帮我们研究出比赫尔卡特精灵更厉害的机械精灵！",function():void
                                       {
                                          NpcTipDialog.show("太好了！我这里有一只卡塔精灵，现在将他交付于你。相信他一定能派上用场！",function():void
                                          {
                                             NpcTipDialog.show("我这就返回骄阳计划，寻找博士！",function():void
                                             {
         ...
         {
            NpcDialog.show(NPC.ELDER,["我是赫尔卡星长老！"],["你知道\"她\"在哪里吗?","哈哈..原来赫尔卡星长老是这个样子..."],[function():void
            {
               EventManager.dispatchEvent(new NpcEvent(NpcEvent.ORIGNAL_EVENT,_curNpcModel));
            },null]);
         }
      }
