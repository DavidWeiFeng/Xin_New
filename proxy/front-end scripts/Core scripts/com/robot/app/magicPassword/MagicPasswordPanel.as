package com.robot.app.magicPassword
{
   ...
   public class MagicPasswordPanel extends Sprite
   {
      ...
      private function configSendBtn(_arg_1:Boolean = true) : void
      {
         if(_arg_1)
         {
      ...
      private function onSendBtnClickHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function configCloseBtn(_arg_1:Boolean = true) : void
      {
         if(_arg_1)
         {
      ...
      private function configBg(_arg_1:Boolean = true) : void
      {
         this.bg.buttonMode = _arg_1;
         if(_arg_1)
         {
      ...
      private function onBgMouseDownHandler(_arg_1:MouseEvent) : void
      {
      ...
      public function hasChineseChar(_arg_1:String) : Boolean
      {
         if(_arg_1 == null)
         {
            return false;
         }
         _arg_1 = this.trim(_arg_1);
      ...
      public function trim(_arg_1:String) : String
      {
         ...
         return this.rtrim(this.ltrim(_arg_1));
      }
      
      public function ltrim(_arg_1:String) : String
      {
         if(_arg_1 == null)
         {
            return null;
         }
         var _local_2:RegExp = /^\s*/;
         return _arg_1.replace(_local_2,"");
      }
      
      public function rtrim(_arg_1:String) : String
      {
         if(_arg_1 == null)
         {
            return null;
