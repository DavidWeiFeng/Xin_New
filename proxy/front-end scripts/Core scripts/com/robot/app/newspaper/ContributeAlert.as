package com.robot.app.newspaper
{
   ...
   public class ContributeAlert
   {
      ...
      public static function show(_arg_1:uint = 1) : void
      {
         _type = _arg_1;
         if(!mc)
         {
         ...
         mc["title_mc"].gotoAndStop(_arg_1);
      ...
      private static function sendHandler(_arg_1:MouseEvent) : void
      {
