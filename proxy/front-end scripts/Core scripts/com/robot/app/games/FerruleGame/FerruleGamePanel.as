package com.robot.app.games.FerruleGame
{
   ...
   public class FerruleGamePanel
   {
      ...
      private function onLoad(_arg_1:MCLoadEvent) : void
      {
         ...
         this.curGame = _arg_1.getContent() as MovieClip;
      ...
      private function onBegainGameHandler(_arg_1:Event) : void
      {
      ...
      private function onStartClickHandler(_arg_1:MouseEvent) : void
      {
      ...
      private function init() : void
      {
         ...
         while(_local_2 < this.circleCount)
         {
            this._circleTipClass = this.loader.loader.contentLoaderInfo.applicationDomain.getDefinition("circletip") as Class;
            _local_1 = new this._circleTipClass() as MovieClip;
            _local_1.scaleX = 0.3;
            _local_1.scaleY = 0.3;
            _local_1.x = _local_2 * 20;
            this._tipMC.addChild(_local_1);
            _local_2++;
         }
      ...
      private function onGamePanelClickHandler(_arg_1:MouseEvent) : void
      {
         if(!this.isThrow)
         {
            this.isThrow = true;
      ...
      private function onShowCircleHandler(_arg_1:Event) : void
      {
      ...
      private function onCircleFrameHandler(_arg_1:Event) : void
      {
      ...
      private function onCircleMCEffectEndHandler(_arg_1:Event) : void
      {
         this.circleStop();
         this.miluReuse();
      }
      
      private function onbalakeMCEffectEndHandler(_arg_1:Event) : void
      {
         this.isHit = false;
      ...
      private function onSeerMCEffectEndHandler(_arg_1:Event) : void
      {
         this.miluReuse();
      }
      ...
      private function remove(_arg_1:Boolean = false) : void
      {
