package com.robot.app.aimat
{
   ...
   public class Aimat_10050 extends BaseAimat
   {
      ...
      override public function execute(_arg_1:AimatInfo) : void
      {
         ...
         if(MainManager.actorModel.direction == Direction.LEFT)
         {
            this.ui.rotation = -150;
         }
         else if(MainManager.actorModel.direction == Direction.RIGHT)
         {
            this.ui.rotation = -30;
         }
