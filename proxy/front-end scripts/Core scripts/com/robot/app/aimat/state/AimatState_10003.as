package com.robot.app.aimat.state
{
   ...
   public class AimatState_10003 implements IAimatState
   {
      ...
      public function AimatState_10003()
      {
         super();
      }
      ...
      public function execute(_arg_1:IAimatSprite, _arg_2:AimatInfo) : void
      {
         ...
         {
            this._obj = BasePeoleModel(_arg_1).skeleton.getBodyMC();
         }
         else
         {
            this._obj = _arg_1.sprite;
         }
