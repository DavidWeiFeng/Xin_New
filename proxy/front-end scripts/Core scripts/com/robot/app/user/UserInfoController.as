package com.robot.app.user
{
   ...
   public class UserInfoController extends BaseBeanController
   {
      ...
      private function onClick(_arg_1:UserEvent) : void
      {
         if(_arg_1.userInfo.userID == MainManager.actorID)
         {
            AllUserInfoController.show(_arg_1.userInfo,LevelManager.appLevel);
         }
         else
         {
            UserInfoController.show(_arg_1.userInfo.userID);
         }
      }
   }
}
