package com.robot.app.specialIcon
{
   ...
   public class SpecialIconList extends Sprite
   {
      ...
      private function onMouseClickHandler(_arg_1:MouseEvent) : void
      {
         var _local_2:VipSession = new VipSession();
      ...
      public function show(_arg_1:DisplayObject) : void
      {
         ...
         this.x = _local_2.x - 220;
         this.y = _local_2.y - this.height + 85;
