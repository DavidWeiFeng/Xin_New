package com.robot.app.petSimulationTraining
{
   ...
   public class PetSimulationTrainingController
   {
      ...
      public static function set info(_arg_1:PetListInfo) : void
      {
         _info = _arg_1;
      }
      ...
      private static function onListComHandler(_arg_1:PetEvent) : void
      {
      ...
      private static function onCloseCoursePanelHandler(_arg_1:Event) : void
      {
      ...
      private static function onOpenCoursePanelHandler(_arg_1:Event) : void
      {
      ...
      private static function onOpenExeingPanelHandler(_arg_1:Event) : void
      {
      ...
      private static function onCloseStartHandler(_arg_1:Event) : void
      {
      ...
      private static function onOpenStartHandler(_arg_1:Event) : void
      {
