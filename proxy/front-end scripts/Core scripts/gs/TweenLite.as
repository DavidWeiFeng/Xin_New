package gs
{
   ...
   public class TweenLite
   {
      ...
      public function TweenLite(_arg_1:Object, _arg_2:Number, _arg_3:Object)
      {
         ...
         this.delay = Number(_arg_3.delay) || 0;
         this.combinedTimeScale = Number(_arg_3.timeScale) || 1;
         ...
         var _local_4:int = _arg_3.overwrite == undefined || !overwriteManager.enabled && _arg_3.overwrite > 1 ? int(overwriteManager.mode) : int(_arg_3.overwrite);
      ...
      public static function updateAll(_arg_1:Event = null) : void
      {
         ...
         var _local_5:uint = uint(currentTime = getTimer());
         var _local_6:Dictionary = masterList;
         for each(_local_2 in _local_6)
         {
            ...
            while(_local_3 > -1)
            {
               ...
               if(_local_4.active)
               {
                  _local_4.render(_local_5);
               }
               else if(_local_4.gc)
               {
                  _local_2.splice(_local_3,1);
               }
               else if(_local_5 >= _local_4.startTime)
               {
                  _local_4.activate();
                  _local_4.render(_local_5);
               }
      ...
      public function render(_arg_1:uint) : void
      {
         ...
         var _local_5:Number = (_arg_1 - this.startTime) * 0.001;
      ...
      public function initTweenVals() : void
      {
         ...
         if(this.vars.runBackwards == true)
         {
            ...
            while(_local_2 > -1)
            {
               ...
               _local_4.start += _local_4.change;
      ...
      public function complete(_arg_1:Boolean = false) : void
      {
         ...
         if(this._hasPlugins)
         {
            ...
            while(_local_2 > -1)
            {
               if(Boolean(this.tweens[_local_2].isPlugin) && this.tweens[_local_2].target.onComplete != null)
               {
